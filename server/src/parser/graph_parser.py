...
class Parser:
    ...
    def parse_nodes(self):
        ...
        """
        return [self.parse_node_feature(feature)
    ...
    def parse_node_feature(self, feature):
        ...
        for point in feature["geometry"]["coordinates"]:
            ...
            if point in self.__node_hashes and \
                    self.__node_hashes[point]["level"] == point_level:
    ...
    def parse_pois(self):
        ...
        """
        return [self.parse_poi(poi)
                for poi in self.json_points["features"]]
    ...
    def parse_poi(self, poi):
        ...
        room = self.poly_parser.in_poly(
            poi_lat_lon, float(poi["properties"]["level"]))
