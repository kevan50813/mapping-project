...
class Router:
    ...
    def __heuristic(self, n, m):
        ...
        n_lat_lon = shapely.geometry.Point(n_node.lat,
                                           n_node.lon)
        m_lat_lon = shapely.geometry.Point(m_node.lat,
                                           m_node.lon)
        ...
        try:
            ...
            if n_poly.tags["indoor"] == "room" \
                    and m_poly.tags["indoor"] == "room":
                # tune this
                weight += 1000
        except KeyError:
            pass
    ...
    def __angle_to(self, n, m, o):
        ...
        v1 = (n_lat_lon[0] - m_lat_lon[0],
              n_lat_lon[1] - m_lat_lon[1])
        v2 = (m_lat_lon[0] - o_lat_lon[0],
              m_lat_lon[1] - o_lat_lon[1])

        dot_product = (v1[0] * v2[0]) + (v1[1] * v2[1])
        r_angle = math.acos(dot_product /
                            (math.hypot(* v1) *
                             math.hypot(* v2)))
